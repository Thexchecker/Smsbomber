...
TOKEN = ""
gif = "https://yt3.googleusercontent.com/Wk5rOHCN3XDl9z6aZ7cdO0XdbMqBTHsAMcIWovLJiEDyqjLlK3AWp6tfWXFhEnLpkvHVhRNasA=s900-c-k-c0x00ffffff-no-rj"
adet = 55
saniye = 0
...
async def on_ready():
    ...
    activity = discord.Activity(type=discord.ActivityType.playing, name="https://github.com/Thexchecker")
